 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) ID_MMFR0 MMU_Get_ID_MMFR0(void)
{
    ID_MMFR0 mmfr0;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) ID_MMFR1 MMU_Get_ID_MMFR1(void)
{
    ID_MMFR1 mmfr1;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) ID_MMFR2 MMU_Get_ID_MMFR2(void)
{
    ID_MMFR2 mmfr2;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) ID_MMFR3 MMU_Get_ID_MMFR3(void)
{
    ID_MMFR3 mmfr3;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) TTBCR MMU_Get_TTBCR(void)
{
    TTBCR ttbcr;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Set_TTBCR(TTBCR ttbcr)
{
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) DACR MMU_Get_DACR(void)
{
    DACR dacr;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Set_DACR(DACR dacr)
{
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) TTBR0 MMU_Get_TTBR0()
{
    TTBR0 ttbr0;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Set_TTBR0(TTBR0 ttbr0)
{       
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) TTBR1 MMU_Get_TTBR1()
{
    TTBR1 ttbr1;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Set_TTBR1(TTBR1 ttbr1)
{
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) SCTLR MMU_Get_SCTLR()
{
    SCTLR sctlr;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Set_SCTLR(SCTLR sctlr)
{
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) uint32_t MMU_Get_VBAR()
{
    uint32_t vbar;
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Set_VBAR(uint32_t vbar)
{
    asm("LDR R0,%0" : "=m"(vbar));
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) uint32_t MMU_Get_FirstLevelTranslationTable_PhysicalAddress(void)
{
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Set_FirstLevelTranslationTable_PhysicalAddress(uint32_t ph_addr)
{
    TTBCR ttbcr = MMU_Get_TTBCR();
    TTBR0 ttbr0 = MMU_Get_TTBR0();
    //TTBR1 ttbr1 = MMU_Get_TTBR1();
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Enable_AccessFlag(ENABLEAF af)
{
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Enable(MMUENABLE mmuenable)
{
    SCTLR sctlr = MMU_Get_SCTLR();
 ...
 * 
 */
__attribute__((section(".c_kernel_text"))) void MMU_Invalidate_TLB(void)
{
